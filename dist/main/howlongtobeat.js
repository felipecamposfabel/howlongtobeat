...
class HowLongToBeatEntry {
    ...
    /* replaces playableOn */
    platforms, imageUrl, timeLabels, gameplayMain, gameplayMainExtra, gameplayCompletionist, similarity, releaseYear, reviewScore, searchTerm) {
        this.id = id;
        this.name = name;
...
class HowLongToBeatParser {
    ...
    static parseDetails(html, id) {
        ...
        return new HowLongToBeatEntry(id, gameName, gameDescription, platforms, imageUrl, timeLabels, gameplayMain, gameplayMainExtra, gameplayComplete, 1, releaseYear, reviewScore, gameName);
    }
    /**
